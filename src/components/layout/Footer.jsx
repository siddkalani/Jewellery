          ...
          <div className='relative flex w-full justify-between'>
            ...
            <div className="footer-end flex justify-center gap-8 items-center w-full ">
              ...
              <div className='star-container flex space-x-6'>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className='star-picture hover:text-[#7e6249]'>
                  <FontAwesomeIcon icon={faFacebook} size="2x" />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className='star-picture hover:text-[#7e6249]'>
                  <FontAwesomeIcon icon={faInstagram} size="2x" />
                </a>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className='star-picture hover:text-[#7e6249]'>
                  <FontAwesomeIcon icon={faTwitter} size="2x" />
                </a>
                <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className='star-picture hover:text-[#7e6249]'>
