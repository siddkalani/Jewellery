...
const ImageCard = ({ className = "" }) => {
  return (
    <div
      className={`flex-1 flex flex-col items-end justify-start pt-[0rem] px-[0rem] pb-[0.625rem] box-border gap-[1.312rem] min-w-[15.25rem] max-w-[15.563rem] text-center text-[1.5rem] text-black font-cormo ${className}`}
    >
      <img
        className="self-stretch h-[17.25rem] relative max-w-full overflow-hidden shrink-0 object-cover"
        alt=""
        src="/jewellery/imageCard/Heart.png"
      />
